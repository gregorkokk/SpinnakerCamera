...
class CAMERA_CONFIG
{
    ...
    public:	
        ...
        int config_sensor_shutter_mode(INodeMap& node_map); // Custom Sensor Shutter Mode
        int config_black_level_clamping_enable(INodeMap& node_map); // Black Level Clamping -> !!! Testing
